            ...
            <div className="max-w-6xl mx-auto">
                <div className="mb-6 sm:mb-10">
                    <div className="flex items-start sm:items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-rose-500 to-pink-600 flex items-center justify-center shadow-sm shadow-rose-500/20 flex-shrink-0">
                        ...
                        <div>
                            <h1 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Divorce Guidebook</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                    {divorceSteps.map((step) => (
                        ...
                        >
                            <div className="h-full bg-white border border-slate-200/80 rounded-xl p-4 sm:p-6 hover:shadow-lg hover:border-navy-200 transition-all duration-200 relative overflow-hidden">
                                {/* Step number badge */}
                                ...
                                <h3 className="text-sm sm:text-base font-semibold text-slate-800 mb-2 group-hover:text-navy-800 transition-colors leading-snug">
                                    {step.title}
                                </h3>
